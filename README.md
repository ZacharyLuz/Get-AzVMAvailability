...
### v3.0.3
- Test dispatch to verify the Actions PR-creation permission fix
...
### v3.0.1
- **Removed 15,376 duplicated lines from `AzVMAvailability/Public/Get-AzVMAvailability.ps1`.** A malformed hunk in the v3.0.0 release commit pasted a full copy of the file over the `<p align="center">
  <img src="assets/header-dark.png" alt="Get-AzVMAvailability - Azure VM SKU restriction, quota, pricing, and placement signals" />
</p>
