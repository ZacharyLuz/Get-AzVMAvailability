...
- Updated `copilot-instructions.md` with current metrics (4,442 lines, 34 functions, 349 Write-Host, 0 exit calls, 208 tests/12 files), line numbers, parent-scope dependency table, and module extraction order
