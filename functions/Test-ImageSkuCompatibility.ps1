# Test-ImageSkuCompatibility.ps1
# Extracted from Get-AzVMAvailability.ps1 (line 2243)
# Tests whether a VM SKU is compatible with the specified image requirements
