# Get-FleetReadiness.ps1
# Extracted from Get-AzVMAvailability.ps1 (line 1154)
# Evaluates fleet BOM readiness across regions checking quota and SKU availability
