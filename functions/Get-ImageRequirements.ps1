# Get-ImageRequirements.ps1
# Extracted from Get-AzVMAvailability.ps1 (line 2147)
# Returns VM image requirements (generation, accelerated networking, etc.) for an image URN
