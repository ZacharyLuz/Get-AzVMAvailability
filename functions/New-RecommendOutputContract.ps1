# New-RecommendOutputContract.ps1
# Extracted from Get-AzVMAvailability.ps1 (line 1533)
# Creates a structured output contract object for recommendation results
